...

{
...

    {
        ...
        $getString .= "orig=AirSide&";

        $getString .= "msg=" . urlencode("Thank you for choosing Manchester Airport Spacess. Your booking with Ref# " . $ref . " is confirmed, for arrival & departure procedure please check your email.") . "&";
...

    {
        ...
        $mail->Username = 'fpo@flightparkone.net';

        $mail->Password = 'oypbwagyenexnmcg';
        ...
        $mail->SetFrom('fpo@flightparkone.net', $from_name);
...

    {
        ...
        $from = "fpo@flightparkone.net";

        $from_name = "Flight Park One";
