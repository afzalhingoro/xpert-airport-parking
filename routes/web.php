...
Route::post('/admin/support/update', [SupportController::class, 'updateBooking'])->name('support.update');
Route::post('/admin/support/cancel/{id}', [SupportController::class, 'cancelBooking'])->name('support.cancel');
Route::post('/admin/support/change-dates/{id}', [SupportController::class, 'changeDates'])->name('support.changeDates');
Route::post('/admin/support/refund/{id}', [SupportController::class, 'processRefund'])->name('support.refund');
Route::post('/admin/support/resend-email/{id}', [SupportController::class, 'resendEmail'])->name('support.resendEmail');
Route::post('/admin/support/{id}/reschedule', [BookingController::class, 'reschedule'])->name('reschedule');
