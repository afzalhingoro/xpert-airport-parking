...
var stripe = Stripe('pk_live_51RPiGuBIL7KIGZC6RddMk7k0DtUKw44LfyO9v5YhpwCud6sJHpXj9igQvdp9tmEuYh5GXCjSqocfHkWAq49hUjR200dE2eTHSO');
//  var stripe = Stripe('pk_test_51QRYHdFj8k3IQAbt6DLOsNErThrPc1WvlDDChdu3tuITLdcyQ9n1w9IEBZ8xp0HS3Bq7liLWrZLWrxaIw1Spk0Lb00ioT3mizN');
...
//
                            ...
                            data['departflight'] = $('#deptFlight').val();
                            ...
                            data['valet_amount'] = $("#valet_amount").val();
                                 ...
                                 console.log(clientSecret);
                                  stripe.handleCardPayment(
                                    ...
                                    if (result.error) {
                                        ...
                                        data['error_msg'] = result.error.message;
                                        ...
                                        $.post('booking/paymentfailed', data, function (data) {
                                            // console.log('error 2');
                                        }, 'json');
