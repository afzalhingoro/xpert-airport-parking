...
<section class="top-bar-section d-none d-md-block">
    <div class="container">
        <div class="row">
            <div style="font-size:15px !important" class="col-lg-7 col-md-12 col-sm-12 topheader">
                ...
                <span class="span-2"><i class="fa-solid fa-phone"></i><a href="tel: 02030051620">
                ...
                <span class="span-2"><i class="fa-solid fa-clock"></i><a>
                        Helpline (Mon- Fri 9AM -5PM)

                    </a></span>
            </div>
            <div class="col-lg-5 col-md-12 col-sm-6 buttonContainer">
