...
@section('content')
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('valet_Booking') }}" method="get" class="form-inline" style="margin-bottom: 10px;">
                    ...
                    <div class="form-group" style="margin-top: 2%;">
                        ...
                        <a href='{{ route('valet_Booking') }}' class="btn btn-primary btn-sm">Reset</a>
                    </div>
                </form>
                                ...
                                <tbody>
                                    @foreach ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td>
                                                @if (isset($booking->valet_type))
                                                    @php
                                                        $valet_type = $booking->valet_type - 1;
                                                        $valet = App\valet::where('id', $valet_type)->first();
                                                        echo $valet->pkg;
                                                    @endphp
                                                @endif
                                            </td>
                                            <td>£{{ $booking->valet_amount }}</td>
