...
@section('stylesheets')
  ...
  td.btn-primary1:hover {
    ...
    vertical-align: middle;
    border-radius: 14px;
    border: 2px solid #0360b3ff;
    
    z-index: 1;
 
}
       @media print {
            #example.bookingListTable th:last-child  {
                display: none !important;
            }
            #example.bookingListTable td:last-child  {
                display: none !important;
            }
        }
    </style>
...
<!-- Button trigger modal -->
    ...
    <div class="page-content">
        ...
        <div class="page-header">
            ...
            @endif
            <div class="row">
                    <form action="{{ route('booking') }}" method="get" class="form-inline mb-10">
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group inputLabel" >
                                <label for="field-1">Search</label>
                                <input type="text" value="{{ Request::get('search') }}" name="search" class="form-control input-sm" id="field-1" value="" placeholder="Search By Keyword">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-12">
                        <div class="form-group inputLabel">
                            <label for="my_status">Booked Status</label>
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group resetSubBtn">
                                <input name="submit" type="submit" value="Search" class="btn btn-primary btn-sm">
                                <a href="{{ route('booking') }}" class="btn btn-primary btn-sm resetBtn">Reset</a>
                            </div>
                        </div>
                    </form>
				...
				@if(count($bookings) > 0)
                    <div class="total_booking_bar row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        @endphp
                        @can('user_auth', ["Totals"])
                        <h2 class="badge badge-info totalBooked"><i class="entypo-target"></i> Total Booked
                            bookings: <span id="no_of_booking">  @php echo  $countCompleted; @endphp
                    ...
                    <div class="col-lg-4 col-md-6 text-right section-right mt-15">
                        <div class="row">
                            <div class="col-xs-12">
                                <ul class="statusList">
                                    <li>
                        ...
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="col-xs-12">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display nowrap bookingListTable">
                                    <thead>
                                        <tr>
                                            <th class="exclude">
                                            ...
                                            @endcan
                                            <th class="exclude">Email Sent</th>
                                            @endif
                                            <!--<th>No of Days</th>-->
                                            <!--<th>Valet</th>-->
                                            @can('user_auth', ["Sources"])
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-danger" id="expand_{{  $booking->id  }}">
                                            ...
                                            <td class="exclude">
										    <button type="button" class="btn btn-primary hide-print" data-toggle="modal" data-target="#asd{{  $booking->id  }}" id="{{  $booking->id  }}" class="plr-10 ptb-0">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <td colspan="11">
                                                <div class="col-md-12">
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tr>
                                                            <td>Net Amount</td>
                                                            <td><span class="label label-sm label-success">£{{ $booking->total_amount }}</span></td>
                                                        </tr>
                                            ...
                                            @endif
												...
												<a id="cancel" class="btn btn-primary btn-minier" title="Cancel Booking No show" onclick="return confirm('Are you sure want to cancel this booking..?')" href="{{ route('cancelNotShow',['id'=>$booking->id]) }}"><i class="entypo-cancel">No Show</i></a>
...
<td data-order="{{ date('Y-m-d', strtotime($booking->returnDate)) }}">
    {{ date('d/m/Y', strtotime($booking->returnDate)) }}
</td>                                            <td class="">{{ date('H:i', strtotime($booking->returnDate)) }}</td>
                                            ...
                                            <td class="">{{ $status}}</td>
                                  @php
    $name = trim($booking->company->name);
@endphp

@if(\Illuminate\Support\Str::contains($name, 'Park and Ride') && 
    (\Illuminate\Support\Str::contains($name, 'Non Flex') || \Illuminate\Support\Str::contains($name, 'Flex')))
    
    @if(\Illuminate\Support\Str::contains($name, 'Summer Special'))
        <td class="btn btn-success">{{ $booking->company->name }}</td>
    @else
<td class="btn btn-primary1">{{ $booking->company->name }}</td>
 @endif
@endif
                                            ...
                                            <td class="exclude">
                                                ...
                                                @if($booking->email_check == 0)
                                                   User <i class="fa fa-close"></i> 
                                                @else
                                                   User <i class="fa fa-check"></i>
                                                @endif
                                                @if($booking->company_check == 0)
                                                   Com <i class="fa fa-close"></i> 
                                                @else
                                                   Com <i class="fa fa-check"></i>
                                                @endif
                                            </td>
