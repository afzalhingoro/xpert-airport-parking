            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        @foreach (collect($social_sites)->chunk(3) as $socialChunk)
    <div class="row">
        @foreach ($socialChunk as $social)
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <div class="form-control-sm"></div>
                        ...
                        {{ Form::textarea('setting[' . $social['fieldName'] . ']', $socialfield, ['rows' => '15', 'class' => 'form-control']) }}
