                ...
                <div class="col-sm-12 infobox-container">
                    <div class="infobox infobox-green">
                        ...
                        <div class="infobox-data">
                            ...
                            <div class="infobox-content">Total Overall </div>
                        </div>

                    </div>
                    @if($role_nam=='Sales' || $role_nam=='SuperAdmin'|| $role_nam=='Developers'|| $role_nam=='Marketing')
                    ...
                    <div class="infobox infobox-blue">
                        ...
                        <div class="infobox-data">
                            <span class="infobox-data-number">{{$todayAgent}}</span>
                            <div class="infobox-content">Agent Bookings Today </div>
                        </div>
                    ...
                    <div class="infobox infobox-blue">
                        ...
                        <div class="infobox-data">
                            <span class="infobox-data-number">{{$todayDept}}</span>
                            <div class="infobox-content">Departure Today</div>
                        </div>
                    ...
                    <div class="infobox infobox-green">
                        ...
                        <div class="infobox-data">
                            <span class="infobox-data-number">{{$todayRet}}</span>
                            <div class="infobox-content">Returns Today</div>
                        </div>
                    ...
                    <!--        <div class="infobox-content">Booking From Main Web</div>-->
                    <!--    </div>-->
 ...
 -->
            ...
            <div class="row">
                <div class="panel panel-primary" style="overflow: hidden;">
                    <div class="panel-heading" style="    background-color: #2BABDC;">
    ...
    jQuery(function($) {
        ...
        var data = [
            @if($role_nam == "Marketing") {
                label: "Google",
                data: @if($count_paid_bookings > 0) {
                    {
                        $count_google_booking_source
                    }
                }
                @else 0 @endif,
                color: "#68BC31"
            ...
            {
                label: "Organic",
                data: @if($count_organic_booking_source > 0) {
                    {
                        $count_organic_booking_source
                    }
                }
                @else 0 @endif,
                color: "#68BC31"
            ...
            {
                label: "Mail Sales",
                data: @if($count_email_booking_source > 0) {
                    {
                        $count_email_booking_source
                    }
                }
                @else 0 @endif,
                color: "#68BC31"
