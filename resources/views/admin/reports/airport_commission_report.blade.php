    ...
    <div class="page-content">
        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb bc-3">
                ...
                <li class="active"><strong>FPO Detail Commission Report</strong></li>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <h2>FPO Detail Commission Report</h2>
        ...
        <form action="{{ route('airport_commission_report') }}" method="get" class="form-inline"
                        ...
                        @if ($show == 1)
                            <div class="col-md-12 text-right section-right" style="margin-top: 10px">
                                ...
                                <a id="excel" class="btn btn-primary exxl"
                                    href="{{ route('companypz_report_excel') }}?filter={{ Request::get('filter') }}&search=&start_date={{ Request::get('start_date') }}&end_date={{ Request::get('end_date') }}&companies={{ Request::get('companies') }}&airport={{ Request::get('airport') }}&status={{ Request::old('status') }}&admins={{ Request::get('admins') }}&payment={{ Request::get('payment') }}&refund_via={{ Request::get('refund_via') }}&palenty_to={{ Request::get('palenty_to') }}"><i
                                    ...
                                    @foreach ($companies as $company)
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                @elseif($company['payment_method'] == 'stripe')
