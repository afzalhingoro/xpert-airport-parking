...
.side-zmd{
    ...
    box-shadow: 2px 5px 4px #00000070;
...
.btn-check:focus+.btn-warning, .btn-warning:focus {
    ...
    background-color: #1773b9;
    border-color: #1773b9;
    box-shadow: 0 0 0 0.25rem rgb(23 115 185 / 38%);
}
        ...
        <div class="container margintop59">
            ...
            <div class="row frombgbooking" >
                ...
                <div class="col-xs-12 col-sm-12 col-md-pull-3 col-lg-9 col-md-9 col-lg-pull-3">
                    ...
                    <ul id="room-list" class="list-unstyled personla-css">
                                ...
                                <div class="row">
                                    ...
                                    <form id="vechile_detail">
                                        ...
                                        <div class="col-xs-12  booking-vehdetal col-sm-12  col-md-12  col-lg-12 room-text">
                                            ...
                                            <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 " style="display:none;">
                                ...
                                <div class="room-list-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 booking-vehdetal  col-sm-12  col-md-12  col-lg-12 room-text">
                                            ...
                                            <h3 class="room-name">Travel Details</h3>
                            ...
                            <div class="room-list-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 booking-vehdetal col-sm-12  col-md-12  col-lg-12 room-text">
                                        ...
                                        <img class="img-responsive" style="display: block;  max-width: 50%; height: auto; margin: auto;" src="{{ secure_asset('assets/payzone/images/payzone_cards_accepted.png') }}">
                                        ...
                                        <div class="paymentFrm" id="paymentFrm">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="card_chrge">
                                                    ...
                                                    <center>  
                                                        <h4 style="margin-top:10px;">
                                                            <span class="badge badge-warning" style="background-color:transparent;" >Your Card Will Be Charged</span> 
                                                ...
                                                <center> 
                                                    <button class="btn cnf_booking btn-lg btn-warning center-block" type="button" id="bookingButton1">Confirm Booking</button>
                                                </center>
                                        ...
                                        <img class="img-responsive" src="{{ secure_asset('assets/payzone/images/payzone_cards_accepted.png') }}">
                                        ...
                                        <form id="payzone_form">
                                            <div class='payzone-form-section'>
                                                ...
                                                <input type="hidden" id="CrossReferenceTransaction" name="CrossReferenceTransaction" value="false"/>
                                                ...
                                                <div id='CardSectionTop' class="col-lg-12 margin15">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input class="form-control bf-inptfld" type="text" name="CardName" required value=""/>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input class="form-control bf-inptfld" type="tel" name="CardNumber" id="CardNumber" value="" required placeholder="XXXX XXXX XXXX XXXX" data-inputmask="'mask': '9999 9999 9999 9999'" pattern="\d{4} \d{4} \d{4} \d{4}" class="masked"/>
                                                ...
                                                <div id='CardSectionTop' class="col-lg-12 margin15">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input class="form-control bf-inptfld" type="text" name="CV2" value="" required maxlength="4" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                                                    ...
                                                    <div class="col-lg-6 exp_monthdd">
                                                        ...
                                                        <label for="ExpiryDateMonth" class="col-lg-12">Expiry Date</label>

                                                        <div class="col-lg-6">

                                                            <select required name="ExpiryDateMonth" class='exp_monthdd_height'>
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <select required name="ExpiryDateYear" class='exp_monthdd_height'>
                                            ...
                                            <div class="card_chrge">
                                                <h3 class="total_charged">Your Card Will Be Charged <strong>£<span id="ccPrice">00.00</span></strong></h3>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="styledpadding">
                                                    <label for="subscribe">

                                                        <input type="checkbox" name="subscribe" class="styled" value="1">
                                            ...
                                            <div class="card_chrge">
                                                ...
                                                <input type="hidden" id="aphactivepayzone" name="aphactive"  value="{{ $data['aphactive'] }}">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-md-push-9 col-lg-push-9 col-lg-3 side-bar">
                    <div class="row" style="margin-top: 4px;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 side-zmd">
                            <div style="background-color: white; padding:20px;">
                                <h3 style="padding:13px 20px 0px !important; margin-bottom: 15px;" class="btn btn-lg btn-yellow col-sm-12 col-xs-12 col-md-12">
                                    <p style="text-align:center;font-size: 18px;line-height: 2;font-weight: 700;color: #ffffff;">
                                        <i style="font-size: 26px;margin-right: 10px;" class="fa fa-shopping-cart"></i> Booking Detail
                                    </p>
                                </h3>   
                                ...
                                <div class="side-bar-block support-block1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-md-8" style="padding-left:0px;">
                                            <p class="text-right" style="font-size: 14px;">{{ \Carbon\Carbon::parse($data["dropdate"])->format('D d M Y') }} at {{ $data["droptime"] }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-6 col-md-4" class="head-text-bookingdetail">Return</div>
                                        <div class="col-xs-6 col-md-8" style="padding-left:0px;">
                                            <p class="text-right" style="font-size: 14px;">{{ \Carbon\Carbon::parse($data["pickdate"])->format('D d M Y') }} at {{ $data["picktime"] }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <hr/>
                                    <div class="row">
                                        <div class="col-xs-6 col-md-6" class="head-text-bookingdetail">Booking Price</div>
                                        <div class="col-xs-6 col-md-6" style="padding-left:0px;">
                                            <p class="text-right" style="font-size: 14px;">£{{ $data["booking_amount"]+$data["discount_amount"] }}</p>
                                        </div>
                                    </div>
                                    <hr/>
                                ...
                                <h3 style="padding:13px 20px 13px !important" class="btn btn-lg btn-yellow col-sm-12 col-xs-12 col-md-12" id="bookingDetails">
                                    Total to pay
