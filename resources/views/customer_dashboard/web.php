...
// Route::get('/customer/admin', 'customer\HomeController@index')->name('customer-admin');
// Route::get('/customer/admin/deals-view', 'customer\DealController@index')->name('deals-view');
// Route::get('/customer/admin/deals-add', 'customer\DealController@add_deal')->name('customer-deals-add');
// Route::get('/customer/admin/deal-edit/{id}', 'customer\DealController@edit_deal')->name('customer-deal-edit');
// Route::post('/customer/admin/deals-create', 'customer\DealController@create_deal')->name('customer-deals-create');
// Route::post('/customer/admin/deals-update', 'customer\DealController@update_deal')->name('customer-deals-update');
// Route::get('/customer/admin/deal-delete/{id}', 'customer\DealController@delete_deal')->name('customer-deal-delete');
