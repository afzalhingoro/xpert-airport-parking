...
<section id="bg-css" style="background-image: url('https://airportdealsparking.co.uk/theme-new/img/banner2.webp');background-size: cover;">
    <div class="container" >
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12"  style="padding-top:67px">
                <p class="h3banner" style=""> Reset Password </p>
