...
@section('content')
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('pickup.bookings') }}" method="get" class="form-inline"
                    ...
                    <div class="form-group sh">
                        ...
                        <a href='{{ route('pickup.bookings') }}' class="btn btn-primary btn-sm">Reset</a>
                    </div>
                </form>
                                    ...
                                    @foreach ($bookings as $booking)
                                        @if ($booking->booking_status == 'Completed')
                                            <tr>
                                                ...
                                                <td class="">
                                                    {{ date('d/m/Y H:i:s', strtotime($booking->departDate)) }}</td>
