      ...
      <div class="col-xs-12">
         ...
         <div class="row">
            <div class="col-xs-12">
               ...
               @endif
               {{ Form::open(array('class'=>'form-horizontal','method'=>'PUT','route' => ['update_user',$user->id],'autocomplete'=>'off', 'files' => true)) }}
               @csrf
               ...
               <div class="form-group">
                  {{ Form::label('Confirm', 'Confirm Password', array('class' => 'col-sm-3 control-label no-padding-right','autocomplete'=>'new-password')) }}
                  <div class="col-sm-9">
               ...
               <div class="form-group">
                  ...
                  <div class="form-control-sm"></div>
                  <div class="col-sm-4 pagetoHide" id="pages_list">
