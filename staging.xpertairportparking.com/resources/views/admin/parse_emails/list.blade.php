                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $counter = 1; ?>
                                    @foreach ($parse_emails as $row)
                                        <tr>
                                            <td class=""><?php echo $counter; ?></td>
                                            <td class=""><?php echo date('d-m-Y H:i:s', strtotime($row->added_on)); ?></td>
                                            <td class=""><?php echo $row->email_from; ?></td>
                                            <td class=""><?php echo $row->email_subject; ?></td>
                                            <!--td class="">
...
@else
    ...
    @endif
                                            ...
                                            <td>
                                                @can('user_auth', ['view'])
                                                    <a href="{{ route('parsed_emails_view', $row->id) }}">
