            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{ Form::open(['class' => 'form-horizontal add_email_template', 'method' => 'PUT', 'route' => ['reviews.update', $review->id], 'files' => true]) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('status', ['Yes' => 'Active', 'No' => 'Inactive'], $review->status, ['class' => 'form-control']) }}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::textarea('review', $review->review, ['id' => 'content', 'class' => 'form-control', 'data-provide' => 'markdown']) }}
