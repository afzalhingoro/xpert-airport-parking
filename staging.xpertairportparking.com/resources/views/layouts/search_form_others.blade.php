...
.icon-cs{top: -51px;margin-right: 9px;}
.icon-cs1{top: -43px;}
}
@media only screen and (min-width: 1400px)  {
...
@media only screen and (min-width: 1400px)  {
   .input-hold.date:before, .input-hold.person:before{margin-right: 10px;}
}
@media only screen and (max-width: 1399px)  {
...
@media only screen and (min-width: 1200px)  {
   #bg-css{height: 326px;}
   .row-searchresult{  margin-top: 25px;}
}
...
<div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row " id="">
                				<div class="col-lg-12 col-md-12 col-sm-12 row-searchresult">
                				    
                					<form class="from-css justify-content-center" method="get" action="{{ route('searchresult') }}" id="search_form_1"style="background-image: url('theme-new/img/Pattern-Form.png');background-size: cover;">
                					    <div class="row search-row">
                					            <div class="col-lg-12 col-md-12">
                        				           <h3 class="text-center quotae-h3"><span>Get</span> a Quote</h3>
                        				        </div>
                        					    <div class="col-xl-2 col-md-6 col-cs col-cs2" >
                                                ...
                                                <div class="col-xl-2 col-md-6 col-cs2" >
                        					            @php
                                                            $dropdown_timer = [];
                                                            for ($i = 0; $i <= 23; $i++) {
                                                                for ($j = 0; $j <= 45; $j += 15) {
                                                ...
                                                <div class="col-xl-2 col-md-6 p-cs col-cs col-cs2" >
                        					            <label for="floatingInput">
                            					           PickUp Date
                            					        </label>
                            					        <div class="input-hold date">
                                                ...
                                                <div class="col-xl-2 col-md-6 p-cs col-cs col-cs2" >
                        					        <div class="mb-3">
                        					            ...
                        					            <label for="floatingInput">
                                                                ...
                                                                <input type="text" class="form-control input-fields-css" placeholder="Optional" name="promo" value="{{ request()->get('promo') }}">
                                                            <!--</div>-->
                                                ...
                                                <div class="col-xl-2 col-md-6 " >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button style=" " type="submit" class="btn other-page-button">Get a Quote</button>
                                                    </div>
                                                </div>
