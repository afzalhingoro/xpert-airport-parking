                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-6">
                        ...
                        <div class="footer-logo">
                            ...
                            <a href="{{ url('/') }}"><img src="{{ url('theme-new/img/new-logo-small.png') }}"
                        ...
                        <ul class="contact-link">
                            ...
                            <li>
                                ...
                                <a href="mailto:helpdesk@airsideparking.uk">

                                    <i class="fa-solid fa-envelope"></i>

                                    helpdesk@airsideparking.uk
                    ...
                    <div class="col-md-6 col-lg-2 col-sm-6">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="{{ url('airport-parking') }}" style="text-decoration: none;">Airport
                                    Parking</a>
                            </li>
                            <li><a href="{{ url('airside-valet-parking') }}" style="text-decoration: none;">Valet
                                    Parking</a></li>
                            <li><a href="{{ url('heathrow-meet-and-greet') }}" style="text-decoration: none;">Meet &
                                    Greet</a></li>
                    ...
                    <div class="col-md-6 col-lg-2 col-sm-6">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="{{ url('customer-login') }}" style="text-decoration: none;">Login /
                                    Register</a></li>
                            <li><a href="{{ url('faqs') }}" style="text-decoration: none;">FAQs</a></li>
                            <li><a href="{{ url('latest-news') }}" style="text-decoration: none;">Latest News</a></li>
                            <!--<li><a href="{{ url('support') }}" style="text-decoration: none;">Contact Us</a></li>-->
                    ...
                    <div class="col-md-6 col-lg-2 col-sm-6">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="{{ url('rewards-and-loyalty') }}" style="text-decoration: none;">Rewards &
                                    Loyalty</a></li>
                            <li><a href="{{ url('car-safety') }}" style="text-decoration: none;">Car Safety at AirSide
                                    Parking.</a></li>
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-12 px-4">
                        ...
                        <div class="row row-css-fo">
                            <ul class="ul-css-fo">
                                <li> <img src="{{ url('theme-new/img/new-member-logo.jfif') }}" class="img-fluid"
                                        alt="logo" loading="lazy"
                                        style="width: 169px;height: 60px;margin-bottom:5px;"></li>
                                <li> <img src="{{ url('theme-new/img/parkmark-logo.webp') }}" class="img-fluid"
                                        alt="logo" loading="lazy" style="width: 169px;height: 71px;"></li>
                            </ul>
                        </div>
...
@else
    ...
    <script>
        $(document).ajaxStop(function() {
                    var url = '{{ $url }}'
                    var replace = url.replace("https://www.airside.markwebhosting.co.uk/result?dropdate=, "
                            ");
                            if (isNaN(replace[0])) {
                                replace = url.replace("http://www.airside.markwebhosting.co.uk/result?dropdate=", "");
                            }

                            if (isNaN(replace[0])) {
                                replace = url.replace("https://airside.markwebhosting.co.uk/result?dropdate=, "
                                    ");
                                }

                                if (isNaN(replace[0])) {
                                    replace = url.replace("http://airside.markwebhosting.co.uk/result?dropdate=, "
                                        ");   }
