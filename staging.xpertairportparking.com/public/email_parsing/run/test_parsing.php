...
if (!$conn) {
  ...
  die("Connection failed: " . mysqli_connect_error());
    ...
    $fullnames = ["Mr. Muhammad Usama Bin Asif", "Rizwan Abbas", "Rizwan Ahmad Abbasi", "Mr. Rizwan Ahmad Abbasi", "usama", "Mr. Rob Mechman"];
    foreach($fullnames as $name){
        $extracted_fullname = extractNameParts($name, true);
        echo "Full Name = <b>$name</b> <br><br>";
        echo "<b>Title</b> = ". $extracted_fullname['title'] ."<br><b>First Name</b> = ". $extracted_fullname['first_name'] ."<br><b>Last Name</b> = ". $extracted_fullname['last_name']."<br><br>----------------------------------------<br><br>" ;
